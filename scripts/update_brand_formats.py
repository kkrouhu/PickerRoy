...
with Image.open(ROOT / "assets/PickerRoy-logo.png") as source:
    ...
    opaque.save(ROOT / "apple/PickerRoyApple/Assets.xcassets/AppIcon.appiconset/icon-ios-1024.png")

catalog = ROOT / "apple/PickerRoyApple/Assets.xcassets/AppIcon.appiconset"
